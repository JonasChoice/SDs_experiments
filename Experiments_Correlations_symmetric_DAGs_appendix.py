...
densities = np.arange(0.05,1.00,0.05)
...
for p in densities:
    ...
    for experiment in range(number_of_experiments):
        ...
        parent_sep.append(mrx.sym_SD_DAGs(G,H,type='parent',normalized = True, MB_enhanced = False))

        MB_enhanced_parent_sep.append(mrx.sym_SD_DAGs(G, H, type='parent', normalized=True, MB_enhanced=True))
...
filename = 'Plots/Correlations/'+ 'DAGs_size_25_500_exps_symmetrized' + '.png'
